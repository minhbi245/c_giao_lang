...
int main()
{
    ...
    // CODE o phien ban nay chay dung ve mat ngu nghia tuy nhien chi voi ki tu A, con voi 'a' thi lai sai
    // Vi may tinh se hieu 'A' va 'a' khac ve mat ON/OFF trong cac transistor/bit, vi ca hai co ma ASCII khac nhau
    return 0;
}